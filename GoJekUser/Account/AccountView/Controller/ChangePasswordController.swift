...
class ChangePasswordController: UIViewController {
    ...
    var isHideOldPassword: Bool = false {
        didSet {
            ...
            oldShowPasswordButton.setImage(UIImage(named: isHideOldPassword ? Constant.eyeOff : Constant.eye), for: .normal)
        }
    }
    ...
    var isHideNewPassword:Bool = false {
        didSet {
            ...
            newShowPasswordButton.setImage(UIImage(named: isHideNewPassword ? Constant.eyeOff : Constant.eye), for: .normal)
        }
    }
    ...
    var isHideConfirmPassword:Bool = false {
        didSet {
            ...
            confirmShowPasswordButton.setImage(UIImage(named: isHideConfirmPassword ? Constant.eyeOff : Constant.eye), for: .normal)
        }
    }
